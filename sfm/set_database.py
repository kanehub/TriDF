...
class COLMAPDatabase(sqlite3.Connection):
    ...
    def update_image_camera_id(self):
        cursor = self.execute(
            "UPDATE images SET camera_id=1")
        return cursor.lastrowid
...
if __name__ == "__main__":
    database_path = r".\sfm\runs\scene_000\2024-07-10_12-13-46\database.db"
    camera_txt = r".\sfm\runs\scene_000\2024-07-10_12-13-46\posed_sparse_model\cameras.txt"

    camTodatabase(database_path, camera_txt)
